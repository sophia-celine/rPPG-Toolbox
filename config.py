...
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.REGION = CN()
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.REGION.MODE = 'RECTANGLE'
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.REGION.SOURCE = 'MEDIAPIPE_FACE'
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.REGION.FILL_MODE = 'FACE_MEAN'
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.REGION.EXCLUDE_EYES = True
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.REGION.EXCLUDE_MOUTH = True
...
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE = CN()
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MAX_NUM_FACES = 1
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MODEL_PATH = 'models/face_landmarker.task'
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_DETECTION_CONFIDENCE = 0.5
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_FACE_PRESENCE_CONFIDENCE = 0.5
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_TRACKING_CONFIDENCE = 0.5
...
_C.VALID.DATA.PREPROCESS.CROP_FACE.REGION = CN()
_C.VALID.DATA.PREPROCESS.CROP_FACE.REGION.MODE = 'RECTANGLE'
_C.VALID.DATA.PREPROCESS.CROP_FACE.REGION.SOURCE = 'MEDIAPIPE_FACE'
_C.VALID.DATA.PREPROCESS.CROP_FACE.REGION.FILL_MODE = 'FACE_MEAN'
_C.VALID.DATA.PREPROCESS.CROP_FACE.REGION.EXCLUDE_EYES = True
_C.VALID.DATA.PREPROCESS.CROP_FACE.REGION.EXCLUDE_MOUTH = True
...
_C.VALID.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE = CN()
_C.VALID.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MAX_NUM_FACES = 1
_C.VALID.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MODEL_PATH = 'models/face_landmarker.task'
_C.VALID.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_DETECTION_CONFIDENCE = 0.5
_C.VALID.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_FACE_PRESENCE_CONFIDENCE = 0.5
_C.VALID.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_TRACKING_CONFIDENCE = 0.5
...
_C.TEST.DATA.PREPROCESS.CROP_FACE.REGION = CN()
_C.TEST.DATA.PREPROCESS.CROP_FACE.REGION.MODE = 'RECTANGLE'
_C.TEST.DATA.PREPROCESS.CROP_FACE.REGION.SOURCE = 'MEDIAPIPE_FACE'
_C.TEST.DATA.PREPROCESS.CROP_FACE.REGION.FILL_MODE = 'FACE_MEAN'
_C.TEST.DATA.PREPROCESS.CROP_FACE.REGION.EXCLUDE_EYES = True
_C.TEST.DATA.PREPROCESS.CROP_FACE.REGION.EXCLUDE_MOUTH = True
...
_C.TEST.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE = CN()
_C.TEST.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MAX_NUM_FACES = 1
_C.TEST.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MODEL_PATH = 'models/face_landmarker.task'
_C.TEST.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_DETECTION_CONFIDENCE = 0.5
_C.TEST.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_FACE_PRESENCE_CONFIDENCE = 0.5
_C.TEST.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_TRACKING_CONFIDENCE = 0.5
...
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.REGION = CN()
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.REGION.MODE = 'RECTANGLE'
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.REGION.SOURCE = 'MEDIAPIPE_FACE'
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.REGION.FILL_MODE = 'FACE_MEAN'
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.REGION.EXCLUDE_EYES = True
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.REGION.EXCLUDE_MOUTH = True
...
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE = CN()
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MAX_NUM_FACES = 1
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MODEL_PATH = 'models/face_landmarker.task'
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_DETECTION_CONFIDENCE = 0.5
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_FACE_PRESENCE_CONFIDENCE = 0.5
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.MEDIAPIPE.MIN_TRACKING_CONFIDENCE = 0.5
    ...
    if config.TRAIN.DATA.EXP_DATA_NAME == '':
        config.TRAIN.DATA.EXP_DATA_NAME = "_".join([config.TRAIN.DATA.DATASET, "SizeW{0}".format(
            ...
            str(config.TRAIN.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.TRAIN.DATA.PREPROCESS.DATA_TYPE)),
                                      ...
                                      "Region{0}".format(config.TRAIN.DATA.PREPROCESS.CROP_FACE.REGION.MODE),
                                      "RegionSource{0}".format(config.TRAIN.DATA.PREPROCESS.CROP_FACE.REGION.SOURCE),
        ...
        if config.VALID.DATA.EXP_DATA_NAME == '':
            config.VALID.DATA.EXP_DATA_NAME = "_".join([config.VALID.DATA.DATASET, "SizeW{0}".format(
                ...
                str(config.VALID.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.VALID.DATA.PREPROCESS.DATA_TYPE)),
                                        ...
                                        "Region{0}".format(config.VALID.DATA.PREPROCESS.CROP_FACE.REGION.MODE),
                                        "RegionSource{0}".format(config.VALID.DATA.PREPROCESS.CROP_FACE.REGION.SOURCE),
    ...
    if config.TEST.DATA.EXP_DATA_NAME == '':
        config.TEST.DATA.EXP_DATA_NAME = "_".join([config.TEST.DATA.DATASET, "SizeW{0}".format(
            ...
            str(config.TEST.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.TEST.DATA.PREPROCESS.DATA_TYPE)),
                                      ...
                                      "Region{0}".format(config.TEST.DATA.PREPROCESS.CROP_FACE.REGION.MODE),
                                      "RegionSource{0}".format(config.TEST.DATA.PREPROCESS.CROP_FACE.REGION.SOURCE),
    ...
    if config.UNSUPERVISED.DATA.EXP_DATA_NAME == '':
        config.UNSUPERVISED.DATA.EXP_DATA_NAME = "_".join([config.UNSUPERVISED.DATA.DATASET, "SizeW{0}".format(
            ...
            str(config.UNSUPERVISED.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.UNSUPERVISED.DATA.PREPROCESS.DATA_TYPE)),
                                      ...
                                      "Region{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.REGION.MODE),
                                      "RegionSource{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.REGION.SOURCE),
