...
def unsupervised_method_inference(config, data_loader):
    ...
    if not config.INFERENCE.EVAL:
        print("Evaluation is disabled. Starting prediction and saving predicted BVP signals...")
...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.UNSUPERVISED.DATA.DATASET == "test":
            unsupervised_loader = data_loader.testLoader.testLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
